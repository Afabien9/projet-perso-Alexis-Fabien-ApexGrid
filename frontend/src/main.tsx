  ...
  return (
    <div className="bg-slate-950 min-h-screen text-white font-sans relative overflow-x-hidden">
      ...
      >
        <nav className="flex flex-col gap-3">
          <button
            ...
            className="w-full text-left font-bold uppercase text-xs p-3 rounded-lg border border-slate-800"
          >
            🏠 Accueil
          </button>
          <button
          ...
          {userRole === "admin" && (
            <button
              ...
              className="w-full text-left font-bold text-xs p-3 rounded-lg border border-amber-900 text-amber-500"
            >
              ⚙️ Admin
            </button>
          )}
      ...
      <div className="w-full pt-12">
        ...
        {/* ... Ajoute ici tes autres vues (calendar, results, etc.) ... */}
      </div>
    </div>
  );
};

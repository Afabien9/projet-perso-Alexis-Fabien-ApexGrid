...
export const GrandPrixSelector: React.FC<GrandPrixSelectorProps> = ({ onSelectRound }) => {
  ...
  return (
    <div className="w-full bg-slate-950 text-white p-4 md:p-10 font-sans">
      <header className="mb-12 max-w-6xl mx-auto border-l-4 border-red-600 pl-5 relative">
        ...
        <p className="text-[10px] font-mono text-slate-500 uppercase tracking-widest mt-1">// Choisissez un circuit pour voir les classements</p>
      </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {grandPrixList.map((gp) => (
            ...
            >
              ...
              {/* Boîtier Tracé du circuit Télémétrique */}
